      ...
      <div className="relative">
        ...
        <div className="mt-5 grid grid-cols-2 divide-x divide-white/10">
          <div className="pr-4">
            ...
            <p className="mt-1 text-sm font-semibold text-[#b09cff]">{familyUserCount} familiar(es)</p>
          </div>
          <div className="pl-4">
            <p className="text-[10px] font-semibold uppercase tracking-widest text-white/30">Permissões</p>
            <p className="mt-1 text-sm font-semibold text-white/85">{permissionCount} regra(s)</p>
          </div>
        </div>
      </div>
    </section>
