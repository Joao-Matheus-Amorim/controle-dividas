...
```txt
G-005 permanece aberto controlado; read/write path admin, access-control, categorias, pessoas/family_members, bancos, gastos, contas-a-pagar e contas-a-receber organization-first estao versionados, mas seeds e schema final seguem transicionais.
```
