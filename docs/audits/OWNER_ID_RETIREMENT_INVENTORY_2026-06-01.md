...
```txt
G-005 permanece aberto controlado; read/write path admin e access-control organization-first estao versionados, mas seeds e schema final seguem transicionais.
```
