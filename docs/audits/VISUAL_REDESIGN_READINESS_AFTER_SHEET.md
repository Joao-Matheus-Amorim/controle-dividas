...
- Finance edit form dialogs were migrated to `Sheet`.
...
Creation and edit flows now use Sheet to improve mobile ergonomics and keep long forms scrollable without feeling like desktop-centered modals.
...
- create/edit flows have a shared Sheet direction;
...
That PR should be documentation-only and should not change UI behavior.
