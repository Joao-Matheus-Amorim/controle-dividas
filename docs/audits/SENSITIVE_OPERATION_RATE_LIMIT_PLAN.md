...
19. Expand to durable/cache-backed storage before public auth flow limits.
20. Add audit outcome events after audit event storage exists.
21. Expand to remaining status transitions.
