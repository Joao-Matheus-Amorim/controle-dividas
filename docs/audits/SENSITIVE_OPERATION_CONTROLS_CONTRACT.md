...
| --- | --- | --- |
| Auth and session flows | login, signup, password reset, password update | Signup authorized email and auth confirm rate limit runtime exist for public auth preflight/verification; remaining auth/session flows still need rate limits and audit outcome model. |
