...
| --- | --- | --- |
| Auth and session flows | login, signup, password reset, password update | Signup authorized email rate limit runtime exists for the public preflight; remaining auth/session flows still need rate limits and audit outcome model. |
