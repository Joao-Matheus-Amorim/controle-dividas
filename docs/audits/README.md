...
| `AI_FINANCE_INTAKE_CONTRACT.md` | Contrato vigente do GAP-020 para IA financeira, com fronteira server-only review-only antes de modelo, provider, endpoint ou salvamento automatico. |
