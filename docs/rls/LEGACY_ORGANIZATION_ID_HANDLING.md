...
Delete deve seguir regra semelhante ao update:

- organization ativa, se `organization_id` preenchido;
- fallback legado por owner seguro, se `organization_id IS NULL`.
