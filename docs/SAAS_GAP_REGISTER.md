...
| GAP-011 | UI contracts | Dashboard, primary finance lists, and primary data-changing forms now have non-brittle UI contracts. | Keep broad visual redesign blocked until a selective visual snapshot strategy exists. |
...
- GAP-011 is reduced by dashboard, finance list, and finance form UI contracts; broad visual redesign still needs explicit snapshot strategy;
