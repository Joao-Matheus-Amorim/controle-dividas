...
- audit event retention preflight runtime versionado em `app/protected/configuracoes/audit-retention-actions.ts` para contagem read-only owner/admin de `audit_events` da organizacao ativa acima de 365 dias, sem cleanup job ou destructive deletion;
