...
- GAP-015 possui contrato de planejamento em `docs/audits/SENSITIVE_OPERATION_CONTROLS_CONTRACT.md` e plano de schema/redaction para audit events em `docs/audits/SENSITIVE_ACTION_AUDIT_EVENT_SCHEMA_PLAN.md`, mas rate limiting, sensitive-action audit logging e data retention runtime controls ainda nao foram implementados.
