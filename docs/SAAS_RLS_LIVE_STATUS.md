...
- category-delete audit logging, rate limiting e data retention runtime controls;
- remocao de `owner_id`;
...
6. planejar GAP-015 por issues separadas antes de runtime de category-delete audit logging, rate limiting ou retention;
