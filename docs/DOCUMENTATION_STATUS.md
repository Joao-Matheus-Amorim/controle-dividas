...
| `docs/audits/AI_FINANCE_INTAKE_CONTRACT.md` | Atual como contrato vigente da IA financeira | Contrato para intents, campos obrigatorios, catalogos permitidos, pessoa logada por padrao e fronteira server-only review-only. | Nao e evidencia de modelo, provider, endpoint, schema, RLS ou salvamento automatico. |
...
| `docs/audits/AI_FINANCE_INTAKE_CONTRACT.md` | Atual | Contrato vigente do GAP-020 para IA financeira, com fronteira server-only review-only. | Nao implementa modelo, endpoint, provider, schema, RLS ou salvamento automatico. |
