...
| `docs/audits/ADMIN_ACCESS_CONTROL_OWNER_ID_RETIREMENT_CONTRACT.md` | Atual como contrato pre-runtime | Contrato para retirar `owner_id` de Admin/access-control. | Bloqueia runtime ate RLS Live Gate, fixture admin multi-org, modelo de convite/admin e rollback. |
