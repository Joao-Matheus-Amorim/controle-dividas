...
| `docs/audits/OWNER_ID_RETIREMENT_INVENTORY_2026-06-01.md` | Atual | Inventario atual do G-005 para planejar retirada futura de `owner_id`. | Mantem `owner_id` como aberto controlado; Admin/access-control e reads de Pessoas ja tem paths organization-first, enquanto writes, schema e demais consumidores seguem transicionais. |
| `docs/audits/OWNER_ID_ACTIVE_CONSUMERS_2026-06-01.md` | Atual | Inventario dos consumidores ativos dos helpers owner-only. | Identifica Admin como excecao ativa, registra reads de Pessoas como consumidor reduzido para organization-first e bloqueia retorno das telas financeiras para helpers legados. |
