...
| `docs/audits/ADMIN_INVITATION_BOOTSTRAP_CONTRACT.md` | Atual como contrato pre-runtime | Contrato para substituir futuramente `ADMIN_EMAIL` por convite/admin por organizacao. | Nao implementa runtime; bloqueia remocao de `ADMIN_EMAIL` e `owner_id` ate convites, audit, rate limit e rollback existirem. |
