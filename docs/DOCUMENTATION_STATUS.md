...
| `docs/audits/AI_FINANCE_PROVIDER_ENDPOINT_CONTRACT.md` | Atual como contrato runtime da IA financeira | Contrato para provider/modelo (OpenRouter), rate limit, auditoria e endpoint `/api/ai/chat`. | Provider runtime implementado; salvamento automatico e escrita por IA seguem fora. |
...
| `docs/audits/AI_FINANCE_PROVIDER_ENDPOINT_CONTRACT.md` | Atual | Contrato runtime do GAP-020 para provider/modelo (OpenRouter), rate limit e endpoint model-backed. | Provider implementado; escrita por IA ainda fora. |
