-- Keep bank balances synchronized with atomic payable/receivable movements.
-- The status update, ledger insert, and bank balance update run in the same
-- database transaction through these RPCs.
