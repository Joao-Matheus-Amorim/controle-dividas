    ...
    <div className="mx-auto flex w-full max-w-md flex-col gap-5 md:max-w-7xl">
      ...
      <section className="relative overflow-hidden rounded-[1.75rem] border border-[#5caaff]/20 bg-[linear-gradient(135deg,#07172e_0%,#061020_55%,#080810_100%)] p-5 shadow-2xl shadow-black/30">
        ...
        <div className="relative">
          <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-white/35">Perfis familiares</p>
          ...
          <div className="mt-5 grid grid-cols-2 divide-x divide-white/10">
            <div className="pr-4">
              ...
              <p className="mt-1 text-sm font-semibold text-[#5caaff]">{familyUsers.length} familiar(es)</p>
            </div>
            <div className="pl-4">
      ...
      <section className="space-y-3 rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-4">
        <div className="flex items-center justify-between">
          <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-white/25">Perfis cadastrados</p>
        ...
        {profiles.map((profile) => {
          ...
          return (
            <div key={profile.id} className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-[#080810]/50 p-3 md:flex-row md:items-center md:justify-between">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Badge variant={profile.role === "admin" ? "default" : "secondary"}>{profile.role === "admin" ? "Admin" : "Usuário"}</Badge>
                  ...
                  <p className="mt-0.5 truncate text-xs text-white/25">Membro financeiro: {profile.family_members?.name || "Sem vínculo"}</p>
                </div>
              </div>
